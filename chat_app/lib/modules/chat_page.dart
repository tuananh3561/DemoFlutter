      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ListView.builder(
              itemCount: this.chatUsers.length,
              shrinkWrap: true,
              padding: EdgeInsets.only(top: 16),
              physics: NeverScrollableScrollPhysics(),
              itemBuilder: (context, index) {
                return ChatUsersList(
                  text: this.chatUsers[index].text,
                  secondaryText: this.chatUsers[index].secondaryText,
                  image: this.chatUsers[index].image,
                  time: this.chatUsers[index].time,
